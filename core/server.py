...
class SecureFastMCP(FastMCP):
    def http_app(self, **kwargs) -> "Starlette":
        ...
        # returned before FastMCP touches the request. Innermost of the four so
        # session context is already populated when a token is rejected.
        ...
        if is_trust_bearer_token_mode():
            ...
            app.user_middleware.insert(3, Middleware(PassthroughAuthMiddleware))
